...
## 12. 애플리케이션 스크린샷 (UI/UX 미리보기)

CampusPool 앱의 주요 화면과 사용자 인터페이스는 다음과 같습니다.

| 로그인 화면                                      | 메인 게시물 목록                               | 역할 기반 필터링                                |
| :----------------------------------------------: | :----------------------------------------------: | :---------------------------------------------: |
| ![Image](https://github.com/user-attachments/assets/db34857c-7f5e-432d-ab20-f6d238ba1379)    | ![메인 화면](기타/주요화면_스크린샷/메인.png)        | ![역할 필터링](기타/주요화면_스크린샷/역할필터.png) |
| **채팅 목록 (예약 상태 아이콘)**                   | **채팅 상세 (예약 버튼)**                        | **건의사항 작성**                               |
| ![채팅 목록](기타/주요화면_스크린샷/채팅목록.png) | ![채팅 상세](기타/주요화면_스크린샷/채팅상세.png)    | ![건의사항](기타/주요화면_스크린샷/건의사항.png)   |
